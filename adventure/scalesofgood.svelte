...
<p>You are a pure deontologist; you think rules are rules, and that the breaking or obeying of them is what determines the goodness of your actions. But you've found that sometimes rules conflict with each other, and when that happens things get weird for you.
</p>
<p>In this case, you've been pretty consistent that you think that lying is wrong. But you also indicated that something like "letting your neighbors get holocausted" seems <i>more wrong</i> to you, so you don't do it. On net, you come out ahead - not so good as if you weren't asked to lie at all, but not as bad as setting murders on the track of good folks.
</p>
